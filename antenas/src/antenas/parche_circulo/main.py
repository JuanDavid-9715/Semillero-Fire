...
def main():
    ...
    var = "array"
    u = "mm"
    val_max = [1.57, 110, 70, 15, 0.017, 30]
    val_min = [1.57, 110, 70, 15, 0.017, 5]
    val_nom = [1.57, 110, 70, 15, 0.017, 15]
    i = 1
    p = 1
    b = 0
    desc = "Patch antenna working in 2.4GHz adapted minimum to -10dB"
